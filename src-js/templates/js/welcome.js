...
welcome.prototype.render_ = function(sb, context, blocks) {
    // line 3
    context["__internal_65e8ded9bc93933b0eac2c74347b26b8_1"] = this.env_.createTemplate(macros);
...
welcome.prototype.block_body = function(sb, context, blocks) {
    ...
    if ((!twig.empty(tmp_name))) {
        ...
        // line 19
        sb.append(context["__internal_65e8ded9bc93933b0eac2c74347b26b8_1"].getlink("\/login", "Please login.", "Login"));
    }
    // line 21
    sb.append("<\/p>\n\n");
};
